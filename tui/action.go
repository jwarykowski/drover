...
var defaultPrompts = map[string]string{
	...
	"sentry.issue.created":       "A Sentry issue opened. Investigate the stack trace and propose a fix.",
	"sentry.issue.resolved":      "A Sentry issue was marked resolved. Confirm the fix is actually in the code, and note it if not.",
